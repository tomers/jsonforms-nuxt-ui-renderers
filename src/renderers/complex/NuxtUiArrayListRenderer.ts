...
export function createNuxtUiArrayListRenderer(theme: NuxtUiRenderersTheme) {
  return defineComponent({
    ...
    setup(props) {
      ...
      function getChildLabelPropFromUiSchemaOptions(
        options: unknown,
      ): string | undefined {
      ...
      return () => {
        ...
        return h(
          ...
          h(
            ...
            {
              default: () =>
                h('div', { class: theme.layoutVertical }, [
                  h('div', { class: theme.flexBetween }, [
                    ...
                    h(
                      UButton as any,
                      {
                        ...
                        color: 'neutral',
                        disabled:
                          !control.value.enabled || maxItemsReached.value,
                  ...
                  items.value.length === 0
                    ? h('div', { class: theme.textMuted }, 'No items.')
                    : null,
                            ...
                            h('div', { class: theme.flexActions }, [
                              ...
                              h(
                                UButton as any,
                                {
                                  ...
                                  disabled:
                                    !control.value.enabled ||
                                    minItemsReached.value,
                                  onClick: () =>
                                    removeItems?.(control.value.path, [
                                      index,
                                    ])(),
                                },
                                { default: () => 'Remove' },
